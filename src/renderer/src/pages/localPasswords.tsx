...
const LocalStorage = (): JSX.Element => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200 font-sans selection:bg-emerald-500/30">
      ...
      {/* Background Decor */}
      <div className="fixed top-0 right-0 w-[500px] h-[500px] bg-emerald-900/10 blur-[120px] pointer-events-none" />
        ...
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold tracking-tight text-white">
              Local <span className="text-emerald-500">Vault</span>
            </h1>
          </div>
          <button
      ...
      <main className="relative container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          {/* Add New Button Card (Visible in grid as well) */}
          <div
            onClick={openShowPasswordModal}
            className="group flex flex-col items-center justify-center min-h-[180px] rounded-2xl border-2 border-dashed border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900 hover:border-emerald-500/50 cursor-pointer transition-all"
          >
            <div className="h-12 w-12 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-400 group-hover:bg-emerald-500 group-hover:text-white transition-colors mb-3">
